...
def lgc(rg_thre):
    ...
    os.system('plink --bfile ../0.example_data/combined --extract lgc_pos.snp --make-bed --out lgc_pos')
    os.system('plink --bfile ../0.example_data/combined --extract lgc_neg.snp --make-bed --out lgc_neg')
    os.system('plink --bfile ../0.example_data/combined --exclude lgc_res.snp --make-bed --out lgc_res')
