...
df_pop1_merge = pd.DataFrame(columns=['id', 'gebv1', 'gebv2', 'gebv_merge'])
...
df_pop1_merge['gebv_merge'] = df_pop1_merge['gebv1'] + df_pop1_merge['gebv2']
...
df_pop2_merge = pd.DataFrame(columns=['id', 'gebv1', 'gebv2', 'gebv_merge'])
...
df_pop2_merge['gebv_merge'] = df_pop2_merge['gebv1'] + df_pop2_merge['gebv2']
